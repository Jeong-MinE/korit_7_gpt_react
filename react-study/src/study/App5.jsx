...
/**
 * 회원 정보를 입력받아 userList에 user객체를 가입하기 버튼을 누를 때 마다 저장한다.                                                                        
...
function App5(props) {
    ...
    const handleSigninButtonOnClick = () => {
        const foundUser = userList.find(user => user.username === signinInputValue.username)  // 객체를 가져옴
        // const result = userList.filter(user => user.username === signinInputValue.username)  배열을 가져옴 
        // console.log(result);
